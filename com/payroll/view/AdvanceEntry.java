...
public class AdvanceEntry extends BaseClass implements ActionListener 
{
...
//		getContentPane().add(label_2);
		...
		lblDispatchEntry = new JLabel("Advance Entry");
		...
		//////////////////////////////////////////////////////////////////////
		String[] crDrColName = {"Sno","Employee Name","ESIC No","PF No.","Code","Advance","Loan",""};
		String cdDrData[][] = {};
	...
	public ArrayList Update() 
	{
		...
		try {
			   ...
			   for (int i = 0; i < s; i++) 
			   {
				   ...
				   emp.setAdvance(setDoubleNumber(col.get(5).toString()));
				   emp.setLoan(setDoubleNumber(col.get(6).toString()));
	...
	public void fillTable()
	{
		...
		Vector<?> v = pdao.getSterliteDaysList(loginDt.getDepo_code(),loginDt.getCmp_code(), loginDt.getFin_year(), mdto.getMnthcode(),2); 
		int size = v.size();
		if(size>0)
		{
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getActionCommand().equalsIgnoreCase("Submit"))
		{
			...
			if(ans==1)
			{
				h = pdao.lockEntry(loginDt.getLogin_id(),loginDt.getLogin_name(),loginDt.getDepo_code(),loginDt.getCmp_code(),mdto.getMnthcode(),2);
				if(h>0)
				{
					alertMessage(AdvanceEntry.this, "Record Locked Sucessfully!!!!");
					//fillTable();
				}
			}
