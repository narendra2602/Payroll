...
public class CouponEntry extends BaseClass implements ActionListener 
{
...
//		getContentPane().add(label_2);
		...
		lblDispatchEntry = new JLabel("Canteen Coupon Entry");
		...
		//////////////////////////////////////////////////////////////////////
		String[] crDrColName = {"Sno","Employee Name","ESIC No","PF No.","Code","Coupon Amount","",""};
		String cdDrData[][] = {};
	...
	public ArrayList Update() 
	{
		...
		try {
			   ...
			   for (int i = 0; i < s; i++) 
			   {
				   ...
				   emp.setCoupon_amt(setDoubleNumber(col.get(5).toString()));
	...
	public void fillTable()
	{
		...
		Vector<?> v = pdao.getSterliteDaysList(loginDt.getDepo_code(),loginDt.getCmp_code(), loginDt.getFin_year(), mdto.getMnthcode(),4); 
		int size = v.size();
		if(size>0)
		{
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getActionCommand().equalsIgnoreCase("Submit"))
		{
			...
			if(ans==1)
			{
				h = pdao.lockEntry(loginDt.getLogin_id(),loginDt.getLogin_name(),loginDt.getDepo_code(),loginDt.getCmp_code(),mdto.getMnthcode(),4);
				if(h>0)
				{
					alertMessage(CouponEntry.this, "Record Locked Sucessfully!!!!");
					//fillTable();
				}
			}
