...
public class EmployeeMasterOold extends BaseClass implements ActionListener 
{
	...
	String repNm;;
	int repno;
	public EmployeeMasterOold(String nm,String repNm)
	{
		setResizable(false);
		setSize(1024, 768);		
				...
				if(evt.getKeyCode() == KeyEvent.VK_ENTER)
				{
				   ...
				   if (option.equals("A"))
				   {
						...
						try
						{
							...
							if (chk)
							{
								JOptionPane.showMessageDialog(EmployeeMasterOold.this,"Code Already Exists " ,"Duplicate Code",JOptionPane.INFORMATION_MESSAGE);						
								emp_code.setText("");
								emp_code.requestFocus();							
								emp_code.setSelectionStart(0);
							}
					...
					{
						alertMessage(EmployeeMasterOold.this, "Emp Code Can not be blank");
						emp_code.setText("");
						emp_code.requestFocus();
						emp_code.setSelectionStart(0);
					}
...
//		bank_name.addFocusListener(myFocusListener);
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		{   
			...
			new EmployeeList(loginDt.getBrnnm(), loginDt.getDrvnm(),sortData,3);
			clearAll();
	...
	public void saveData()
	{
		if(option.equals("A"))
		{
			if (emp_code.getText().length()>0)
			{
				...
				alertMessage(EmployeeMasterOold.this, "A/c Code Can not be blank");
		}
		else
		{
	...
	public void setFieldEnabled(boolean b)
	{
	 ...
	 public class DateComparator implements Comparator<EmployeeMastDto> {
			public int compare(EmployeeMastDto e1, EmployeeMastDto e2) {
				long n1 = 0;
				if(e1.getDoresign()!=null) n1=e1.getDoresign().getTime();
				long n2 = 0;
				if(e2.getDoresign()!=null) n2=e2.getDoresign().getTime();
/*				if(e1.getDoresign()==null || e2.getDoresign()==null)
					return 1;
				else if(e1.getDoresign()!=null && e2.getDoresign()!=null)
				    return (e1.getDoresign().after(e2.getDoresign())) ? -1 : (e1.getDoresign().before(e2.getDoresign())) ? 1 : 0;
				    //return e1.getDoresign().compareTo(e2.getDoresign());
				else
					return 0;
*/				
