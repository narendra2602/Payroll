...
public class MiscEntry extends BaseClass implements ActionListener 
{
...
//		getContentPane().add(label_2);
		...
		lblDispatchEntry = new JLabel("Other Allowance Entry");
		...
		//////////////////////////////////////////////////////////////////////
		String[] crDrColName = {"Sno","Employee Name","ESIC No","PF No.","Code","Misc Amount","",""};
		String cdDrData[][] = {};
	...
	public ArrayList Update() 
	{
		...
		try {
			   ...
			   for (int i = 0; i < s; i++) 
			   {
				   ...
				   emp.setMisc_value(setDoubleNumber(col.get(5).toString()));
	...
	public void fillTable()
	{
		...
		Vector<?> v = pdao.getSterliteDaysList(loginDt.getDepo_code(),loginDt.getCmp_code(), loginDt.getFin_year(), mdto.getMnthcode(),3); 
		int size = v.size();
		if(size>0)
		{
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(e.getActionCommand().equalsIgnoreCase("Submit"))
		{
			...
			if(ans==1)
			{
				h = pdao.lockEntry(loginDt.getLogin_id(),loginDt.getLogin_name(),loginDt.getDepo_code(),loginDt.getCmp_code(),mdto.getMnthcode(),3);
				if(h>0)
				{
					alertMessage(MiscEntry.this, "Record Locked Sucessfully!!!!");
					//fillTable();
				}
			}
