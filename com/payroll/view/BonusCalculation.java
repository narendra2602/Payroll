...
public class BonusCalculation extends BaseClass implements ActionListener 
{
...
//		getContentPane().add(label_2);
		...
		lblDispatchEntry = new JLabel("Bonus Calculation");
		...
		//////////////////////////////////////////////////////////////////////
		String[] crDrColName = {"Sno","Employee Name","ESIC No","PF No.","Code","Bonus %","Bonus Limit","",""};
		String cdDrData[][] = {};
	...
	public ArrayList Update() 
	{
		...
		try {
			   ...
			   for (int i = 0; i < s; i++) 
			   {
				   ...
				   emp.setBonus_per(setDoubleNumber(col.get(5).toString()));
				   emp.setBonus_value(setDoubleNumber(col.get(6).toString()));
				   emp.setNet_value(setDoubleNumber(col.get(8).toString())); // bonus_applicable
	...
	public void fillTable()
	{
		...
		int mncode=0;
		Vector<?> v = pdao.getBonusList(loginDt.getDepo_code(),loginDt.getCmp_code(), loginDt.getFin_year(), mdto.getMnthcode(),2); 
		int size = v.size();
		if(size>0)
		{
